      ...
      <div className="container-malmequer">
        <div className="flex h-16 sm:h-20 items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0 min-w-0">
            ...
            <div className="hidden md:flex items-center gap-2 lg:gap-3">
              <a
                ...
                className="w-8 h-8 lg:w-9 lg:h-9 rounded-full bg-white border border-ink flex items-center justify-center"
                aria-label="Facebook"
              >
                <svg className="h-4 w-4 text-malmequer-gold fill-current" viewBox="0 0 24 24">
              ...
              <a
                ...
                aria-label="TikTok"
              >
                <TikTokIcon className="h-4 w-4 text-malmequer-gold fill-current" />
              </a>
            </div>
          </div>
          ...
          <Link href="/" className="flex items-center justify-center flex-shrink-0">
            <div className="text-4xl sm:text-5xl lg:text-6xl text-ink font-[family-name:var(--font-imperial-script)] whitespace-nowrap">
              Malmequer
            </div>
          </Link>
