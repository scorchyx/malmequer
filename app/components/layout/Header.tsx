          ...
          <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0 min-w-0">
            ...
            <div className="hidden md:flex items-center gap-2 lg:gap-3">
              <a
                ...
                className="w-8 h-8 lg:w-9 lg:h-9 rounded-full bg-white flex items-center justify-center"
                aria-label="Facebook"
              >
                <svg className="h-4 w-4 text-ink fill-current" viewBox="0 0 24 24">
              ...
              <a
                ...
                aria-label="TikTok"
              >
                <TikTokIcon className="h-4 w-4 text-ink fill-current" />
              </a>
            </div>
          </div>
