        ...
        <div className="container-malmequer">
          <div className="max-w-2xl text-center sm:text-left mx-auto sm:mx-0">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 max-w-sm mx-auto sm:mx-0">
              ...
              <Link
                href="/ver-tudo"
                className="flex items-center justify-center text-center px-8 py-4 bg-malmequer-gold text-ink uppercase tracking-wider text-sm font-medium leading-none active:scale-95 hover:bg-malmequer-amber transition-all shadow-xl touch-manipulation"
              >
                Novidades
              </Link>
            </div>
